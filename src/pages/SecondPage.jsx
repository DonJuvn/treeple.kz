import React from "react";const SecondPage = () => {
   return (
      <div id="second-page">
         <div className="list">
            <p id="none">Almaty</p>
         ...
         <div className="left">
            ...
            <div className="mark">
               ...
               <p>
                  ...
                  accommodation at <b>Ritz-Carlton Almaty﻿</b>. After settling
                  in, take a leisurely stroll around the city center to get
                  acquainted with the local atmosphere. <br />
                  <br />
                  Day 2: Explore Almaty's Cultural Heritage Start your day by
                  visiting <b>Central State Museum of Kazakhstan﻿</b> to learn
                  about the country's rich history. Then, head to 
                  <b>Panfilov Park﻿</b>, where you can admire the stunning 
                  <b>Zenkov Cathedral﻿</b>. For lunch, enjoy traditional Kazakh
                  cuisine at <b>Gakku Restaurant﻿</b>.
               </p>
            </div>
            <div className="chat">
               <div className="input">
         ...
         <div className="right">
            ...
            <div className="name">
               ...
               <p><img src="img/bed.png" alt="" />Hotel</p>
            </div>
            ...
            <div className="bottom">
               <div className="left">
                  <p>The Ritz-Carlton Almaty is a luxury hotel located within the Esentai Tower, one of the tallest buildings in Kazakhstan. This hotel offers panoramic views of the city and the Trans-Ili Alatau mountains. It features elegantly designed rooms and suites...</p>
                  <a href="#">Read more</a>
               </div>
               <div className="right">
                  <div className="price">
